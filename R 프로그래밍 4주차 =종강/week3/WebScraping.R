#   https://search.naver.com/search.naver?sm=top_hty&fbm=1&ie=utf8&query=%EC%A0%9C%EC%A3%BC%EC%A7%81%ED%95%AD+%ED%8A%B9%EA%B0%80

#    https://search.naver.com/search.naver 여기까지가 도메인

#     ? 다음부터는 get 방식으로 header 에 들어가는 것

#     ?sm=top_hty&fbm=1&ie=utf8&query=%EC%A0%9C%EC%A3%BC%EC%A7%81%ED%95%AD+%ED%8A%B9%EA%B0%80
#                   ############ 여기부터는 한글/ 한글이 이렇게 저장됨      
